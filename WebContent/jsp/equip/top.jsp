...
<body>
        <nav class="navbar navbar-default top-navbar" role="navigation">
			...
			<div>
				...
				<a class="topspan" href="#/equipRealInfo/index.jsp"><h4 class="fa fa-tasks">设备实时状态信息</h4></a>
				<a class="topspan" href="#/equipRealInfo/index.jsp"><h4 class="fa fa-bell">设备报警信息</h4></a>
				<a class="topspan" href="#/bigData"><h4 class="fa fa-bell">大数据分析</h4></a>
			</div>
        </nav>
