...
public interface EquipmentService {
	...
	/*
	 * // 添加设备分类信息 boolean save(EquipType equip_type);
	 */

	/*
	 * // 添加设备制造商信息 boolean save(EquipManu equip_manu);
	 */
	...
	/*
	 * //获取设备制造商信息 List<EquipManu> getEquipManuInfo();
	 */
	/*
	 * //添加设备特征参数信息 boolean save(EquipPara equip_para);
	 */
	...
	/*
	 * // 查询维保信息总条数 Integer countEmTotal(String searchKey); // 根据页数筛选全部设备维保信息列表
	 * List<EquipMain> selectEquipMainByPage(String searchKey, Integer offset,
	 * Integer end);
	 */
